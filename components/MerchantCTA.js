...
export default function MerchantCTA() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:7000/site/merchant-enquiries", {
        method: "POST",
        headers: {
  ...
  return (
    <section className="w-full py-24 px-5 md:px-12 lg:px-24 bg-white relative overflow-hidden">
