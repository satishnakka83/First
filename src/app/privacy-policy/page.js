  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        <h1 className="lg:text-3xl font-bold mb-4 text-black">📄 Privacy Policy – Customer App ( Clothing E-Commerce)</h1>
        <p className="text-gray-600 mb-6">Last Updated: 27th, June 2026</p>
